...
<body>
    ...
    <div class="form-container">
        ...
        <form action="update" method="POST">
            ...
            <select id="b.bname" name="b.bname" value="${data.b.bname}"required>
            ...
            <select id="b.f.fname" name="b.f.fname" value="${data.b.f.fname}" required>
                <option value="Kunal Sir">Kunal Sir</option>
                <option value="Mane Sir">Mane Sir</option>
                <option value="Nanu Sir">Nanu Sir</option>
            </select>
            
            <label for="cname">Course Name:</label>
            <select id="b.f.c.cname" name="b.f.c.cname" value="${data.b.f.c.cname}" required>
